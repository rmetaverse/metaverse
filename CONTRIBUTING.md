# Contributing to metaverse

The goal of this guide is to help you get up and contributing to metaverse as 
quickly as possible.

Please note that metaverse is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md). By contributing to this project, you agree to abide by its terms.
...
Similarly, typos/errors in the supporting documents (e.g. these contributing guidelines, NEWS.md, CODE_OF_CONDUCT.md)
...
### Proposing a new package for addition to the metaverse

If you wish to propose a package for inclusion, you will need to open an issue using the "Package inclusion request" template.

This template asks you to complete the following sections so that we can make a judegement on whether the proposed package is good fit for addition to the metaverse.
