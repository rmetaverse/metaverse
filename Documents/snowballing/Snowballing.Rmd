...
# Instructions for snowballing searches of different databases     
Alison Bethel says that her colleague is writing a paper (or has written one?) where they compare Scous and WoS. Scopus performed a bit better. But the best practice is to search multiple databases.     
Start with list of papers (your core set)     

Convert the titles of the papers to a search string    

## Scopus     
#### Advanced Search     
E.g. TITLE-ABS-KEY("Effectiveness and efficiency of search methods in systematic reviews of complex evidence" OR "Guidelines for snowballing in systematic literature studies and a replication in software engineering" OR "Automatic Evidence Retrieval for Systematic Reviews")

Select 'All'

#### Forward Search      
Select 'View references'         

#### Backward Search       
Select 'View cited by'   

## Web of Science      
#### Forward Search      
#### Cited Reference Search       
##### Cited Title 
"Effectiveness and efficiency of search methods in systematic reviews of complex evidence" OR "Guidelines for snowballing in systematic literature studies and a replication in software engineering" OR "Automatic Evidence Retrieval for Systematic Reviews"

Have to manually select the papers that you want, then press "Finish Search"         

#### Backward Search       
Very tedious!     

Advanced Search: TS=("Effectiveness and efficiency of search methods in systematic reviews of complex evidence" OR "Guidelines for snowballing in systematic literature studies and a replication in software engineering" OR "Automatic Evidence Retrieval for Systematic Reviews")    

Have to click "Times Cited" next to each article    
