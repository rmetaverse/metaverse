...
vignette: >
  %\VignetteIndexEntry{metaDigitise}
...
2. [Setting up directory structures](#P3)
3. [Example of how it works](#P4)
4. [Processing batches of figures of different types](#P5)
5. [Re-importing previously digitised data and accessing raw data](#P6)
6. [Editing and plotting digitised figures](#P7)
